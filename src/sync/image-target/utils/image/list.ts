...
export const buildImageList = (inputImage: ImageData) => {
  ...
  const imageList: (ImageData & { scale: number })[] = scaleList.map((scale) =>
...
export const buildTrackingImageList = (inputImage: ImageData) => {
