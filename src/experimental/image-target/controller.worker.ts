...
import { IControllerWorker, WorkerEvent } from '../../image-target/utils/types/controller';
import { WORKER_EVENT } from '../../image-target/utils/constant/controller';
import { IKeyFrame } from '../../image-target/utils/types/compiler';
