const vector2DDistance = (vecA: number[], vecB: number[]): number[] => [
  vecA[0] - vecB[0],
  vecA[1] - vecB[1],
];
...
const linePointSide = (A: number[], B: number[], C: number[]): number =>
...
export { linePointSide, areaOfTriangle, vector2DDistance, determinant };
