...
import { Detector } from '../../detector/image-target/detector';
import { imageTarget } from '../../image-list';
import { build as hierarchicalClusteringBuild } from '../../matching/image-target/hierarchical-clustering';
import { IKeyFrame, ImageDataWithScale } from './interfaces';

// TODO: better compression method. now grey image saved in pixels, which could be larger than original image

const CURRENT_VERSION = 2;
const { buildImageList, buildTrackingImageList } = imageTarget;
